...
<style lang="css">
/*
  From https://codepen.io/nikhil/pen/tnsCf
 */
 .search-box{
     margin:0 auto;
 }
...
.search:-moz-placeholder { /* Firefox 18- */
 ...
 .search-default {
     ...
     width:120px;
     padding:6px 15px 6px 35px;
     box-shadow: 0 1px 0 rgba(255, 255, 255, 0.1), 0 1px 1px rgba(204, 204, 204, 0.5) inset;
     text-shadow: none;
     border-radius:7px;
     -webkit-transition: all 0.7s ease 0s;
 }

 .search-default:focus{
